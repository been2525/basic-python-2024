...
class Car:
    wheel_num = 4
    color = 'white'
    __plate_num = '' ## __앞에 붙이면 악의적인 변경 막음
    company = ''
    gear_type = ''

    # 전진, 후진 좌회전, 우회전 # 동사는 함수로 명사는 변수로
    ...
    def __str__(self) -> str: # print(객체) 출력되는 부분
        return f'제차는 {self.__plate_num} 입니다. {self.color}입니다.'
...
sarah.__plate_num = '98하 7789' # 악의적인 의도를 가지고 변경 -> 하면 안됨
print(sarah)
