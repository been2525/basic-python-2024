...
print(string_3)
# 정수를 문자열 포맷
#=: 기호와 숫자를 분리, 02d: 두자리수 만들때 빈자리 0으로 채우기 05d: 다섯자리 만들때 빈자리 0으로 채우기, d:정수 <- 이거 많이 쓰임
string_4 = '______{:=+10d}_____'.format(-100) # 
print(string_4)
...
# 파이썬 3.6 이후 도입. format() 함수를 아예 사용 안함 <- string_5랑 결과가 같지만 이 방법이 더 현대식 방법 고로 이 방법 쓰는 것을 추천
