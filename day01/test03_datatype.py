...
## None형 == null(C, C++, Java, SQL)
## 값은 값인데 아무것도 지정할 수 없는 값 => None (어떠한 값도 가지지 않고 있다는 뜻)
## 이용할 수 없는, 할당되지 않은 적용불가능 하다는 의미(null)
...
oct9 = 0o11 # 0,1,2,3,4,5,6,7,10,11,12,13,14,15,16,17,20 (10 => 8)
...
multi_str = '''Hello\n
I am a programmer.\n
Have a good afternoon.'''# ghxEkdhavy''', 쌍따옴표 """ 동일
print(multi_str)
multi_str2 =  'Line1\n' \
              'Line2\n' \
